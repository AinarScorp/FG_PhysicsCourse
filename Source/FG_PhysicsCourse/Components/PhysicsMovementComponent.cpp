...
void UPhysicsMovementComponent::PhysicsMove_Implementation(UPrimitiveComponent* RootComp, FBallPhysicsProperties CurrentBallProperties, FVector2D MoveInput)
{
}
